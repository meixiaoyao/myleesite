...
import com.zyw.myleesite.common.security.Digests;
...
import com.zyw.myleesite.common.service.ServiceException;
import com.zyw.myleesite.module.sys.dao.MenuDao;
import com.zyw.myleesite.module.sys.dao.RoleDao;
import com.zyw.myleesite.module.sys.dao.UserDao;
...
import com.zyw.myleesite.module.sys.security.SystemAuthorizingRealm;
import com.zyw.myleesite.module.sys.utils.LogUtils;
    ...
    public void saveUser(User user) {
        ...
        if (StringUtils.isNotBlank(user.getId())) {
            ...
            if (user.getRoleList() != null && user.getRoleList().size() > 0) {
                ...
                throw new ServiceException.getLoginName() + "没有设置角色");
            }
            // 清除用户缓存
