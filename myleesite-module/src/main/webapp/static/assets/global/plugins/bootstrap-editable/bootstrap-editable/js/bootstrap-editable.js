    ...
    */
    ...
    $.fn.editableform.defaults = {
        ...
        **/         
        showbuttons: true,
        /**
        Scope for callback methods (success, validator).
    ...
    **/
    $.fn.editable = function (option) {
        ...
        switch (option) {
            ...
            @example
            $('#username, #fullname').editable('validator');
            // possible result:
            {
            ...
            **/
            case 'submit':  //collects value, validator and submit to server for creating new record
